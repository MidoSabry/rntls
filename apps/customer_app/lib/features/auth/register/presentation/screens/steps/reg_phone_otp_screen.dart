...
class RegPhoneOtpScreen extends ConsumerStatefulWidget {
  const RegPhoneOtpScreen({super.key});

  @override
  ConsumerState<RegPhoneOtpScreen> createState() => _RegPhoneOtpScreenState();
}

class _RegPhoneOtpScreenState extends ConsumerState<RegPhoneOtpScreen> {
  Timer? _t;
  int _seconds = 30;
